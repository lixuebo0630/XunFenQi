 ...
 * File Name:EditTextWithDelete.java
 * Package Name:com.haihefinance.view
 * Date:2015-8-17下午3:33:18
...
/**
 * 
 * @ClassName: EditTextWithDelete
 * @Description: 自定义带清除功能的Edittext
 * @author Xuebo Li
 * @date 2015-8-17 下午3:39:05
 * 
 */
public class EditTextWithDelete extends EditText implements
	...
	private void init() {
		// 获取图片资源
		imgEnable = context.getResources().getDrawable(R.drawable.clear_icon);
