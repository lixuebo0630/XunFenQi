 ...
 */
package com.xunfenqi.view.wheel;
...
import com.xunfenqi.utils.AbDateUtil;
import com.xunfenqi.utils.AbDialogUtil;
import com.xunfenqi.utils.AbStrUtil;
import com.xunfenqi.view.wheel.AbWheelView.AbOnWheelChangedListener;
...
public class AbWheelUtil {
	...
	public static void initWheelDatePicker(final Activity activity,
			...
			boolean initStart, final TextView tv_return_date, final int qixian) {
		...
		mText.setText(AbStrUtil.dateTimeFormat(defaultYear + "-" + defaultMonth
				+ "-" + defaultDay));
		...
		okBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				String currentDate = AbStrUtil.dateTimeFormat(year + "-"
						+ month + "-" + day);
				// 起息是T+1 回款日要+1天
				String currentDateByOffset = AbDateUtil.getStringByOffset(
						currentDate, "yyyy-MM-dd", Calendar.DATE, qixian + 1);
				mText.setText(currentDate);
				tv_return_date.setText(currentDateByOffset);
			}
	 ...
	 */
	public static void initWheelTimePicker(final AbActivity activity,
		...
		String val = AbStrUtil.dateTimeFormat(defaultYear + "-" + defaultMonth
