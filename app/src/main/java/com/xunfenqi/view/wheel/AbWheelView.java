...
import com.xunfenqi.utils.AbGraphicUtil;
...
/**
 * 
 * @ClassName: AbWheelView
 * @Description: 自定义轮子
 * @author Xuebo Li
 * @date 2015-10-22 下午7:55:20
 * 
 */
public class AbWheelView extends View {
	...
	private static int[] SHADOWS_COLORS = new int[] { 0xFFf, 0xfff,
			0xfff };
	...
	private int[] centerSelectGradientColors = new int[] { 0xfff,
			0xfff, 0xfff };
	...
	/** 轮子的背景 底部的颜色 */
	private int[] bottomGradientColors = new int[] { 0xfff, 0xfff, 0xfff };

	/** 轮子的背景 顶部的颜色 */
	private int[] topGradientColors = new int[] { 0xfff, 0xFFF, 0xfff };
	...
	/** 中间覆盖条高度. */
	private int additionalItemHeight = UIUtils.dip2px(30);
