...
public class ExpandableTextView extends LinearLayout implements
	...
	private static final int MAX_COLLAPSED_LINES = 18;
	...
	protected RelativeLayout mButton; // Button to expand/collapse
	...
	private void init(AttributeSet attrs) {
		...
		if (mExpandDrawable == null) {
			mExpandDrawable = getDrawable(getContext(),
					R.drawable.ic_expand_small_holo_light);
		}
		if (mCollapseDrawable == null) {
			mCollapseDrawable = getDrawable(getContext(),
	...
	private void findViews() {
		...
		mButton = (RelativeLayout) findViewById(R.id.rl_btn_message_act_item_dowm);
