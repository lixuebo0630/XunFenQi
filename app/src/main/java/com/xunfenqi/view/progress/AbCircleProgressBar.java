...
/**
 * 
 * @ClassName: AbCircleProgressBar
 * @Description: 环形的ProgressBar
 * @author Xuebo Li
 * @date 2015-9-7 下午3:51:53
 * 
 */
public class AbCircleProgressBar extends View {
	...
	private int[] arcColors = new int[] { 0xFF02C016, 0xFF3DF346, 0xFF40F1D5,
			0xFF02C016 };
	private int[] arcAColors = new int[] { 0xFF02C016, 0xFF02C016, 0xFF02C016,
			0xFF02C016 };
	...
	protected void onDraw(Canvas canvas) {
		 ...
		 * 
		 * //按颜色比例圆形填充 RadialGradient radialGradientShader = new
		...
		if (mAProgress == max) {
			...
			progress = 100;
			SweepGradient sweepGradient1 = new SweepGradient(this.width / 2,
					this.height / 2, arcAColors, null);
			fillArcPaint.setShader(sweepGradient1);
			invalidate();
