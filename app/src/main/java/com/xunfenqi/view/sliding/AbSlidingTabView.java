...
import com.xunfenqi.adapter.AbFragmentPagerAdapter;
...
/**
 * 
 * @ClassName: AbSlidingTabView
 * @Description: 滑动的tab,tab不固定超出后可滑动.
 * @author Xuebo Li
 * @date 2015-8-17 下午2:06:37
 * 
 */
@SuppressLint("NewApi")
public class AbSlidingTabView extends LinearLayout {
	...
	public AbSlidingTabView(Context context, AttributeSet attrs) {
		...
		this.addView(mViewPager, new LayoutParams(
	...
	public AbSlidingTabView(Fragment fragment) {
		...
		if (VERSION.SDK_INT <= 17) {
			AbLogUtil.e(AbSlidingTabView.class,
					"AbSlidingTabView(Fragment fragment) 要求最低SDK版本17");
			return;
		}
	...
	public void initView() {
		...
		if (!(this.context instanceof FragmentActivity)) {
			AbLogUtil.e(AbSlidingTabView.class,
					"构造AbSlidingTabView的参数context,必须是FragmentActivity的实例。");
		}
	}
