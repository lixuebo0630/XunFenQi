...
import com.xunfenqi.adapter.AbViewPagerAdapter;
import com.xunfenqi.utils.AbFileUtil;
...
/**
 * 
 * @ClassName: AbSlidingPlayView
 * @Description: 可播放显示的View.
 * @author Xuebo Li
 * @date 2015-8-17 下午2:30:47
 * 
 */
public class AbSlidingPlayView extends LinearLayout {
	...
	public void initView(Context context) {
		...
		// mNavLayoutParent.setPadding(0,5,150,5);
