package com.xunfenqi.view.titlebar;
...
/**
 * 
 * @ClassName: AbTitleBar
 * @Description: 标题栏实现.
 * @author Xuebo Li
 * @date 2015-8-14 下午3:10:51
 * 
 */
public class AbTitleBar extends LinearLayout {
	...
	public void ininTitleBar(Context context) {
		...
		// 设置边距
		layoutParamsWW.setMargins(30, 0, 0, 0);
		...
		logoView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				mActivity.finish();
				// mActivity.overridePendingTransition(R.anim.activity_left2right,
	...
	public void setLogo(int resId) {
		...
		logoView.setPadding(0, 14, 14, 14);
	}
