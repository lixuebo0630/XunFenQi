...
import com.xunfenqi.view.AbMultiColumnListView;
...
public class AbViewUtil {
	...
	public static AbTitleBar getTTitleBar(Context context, String titleText) {
		// 初始化ActionBar
		AbTitleBar mAbTitleBar = ((AbActivity) context).getTitleBar();
		// 设置标题文本
		mAbTitleBar.setTitleText(titleText);
		mAbTitleBar.setTitleTextSize(16);

		mAbTitleBar.setTitleBarBackgroundColor(Color.parseColor("#ff7406"));
		// 设置对齐方式
		mAbTitleBar.setTitleBarGravity(Gravity.CENTER, Gravity.CENTER);
		mAbTitleBar.setTitleTextMargin(0, UIUtils.px2dip(40), 0,
				UIUtils.px2dip(40));
