 ...
 * @see
 */
public class CurrentToOrdinaryBeginInfo {
	private String messageType;
	private String respCode;
	private String respCodeDesc;
	private String userId;
	private String hqzcje;
	...
	public String getHqzcje() {
		return hqzcje;
	}

	public void setHqzcje(String hqzcje) {
		this.hqzcje = hqzcje;
	}

	@Override
	public String toString() {
		return "CurrentToOrdinaryBeginInfo [messageType=" + messageType
				+ ", respCode=" + respCode + ", respCodeDesc=" + respCodeDesc
				+ ", userId=" + userId + ", hqzcje=" + hqzcje + ", signValue="
				+ signValue + "]";
	}
