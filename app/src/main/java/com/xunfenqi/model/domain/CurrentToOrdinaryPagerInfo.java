 ...
 * @see
 */
public class CurrentToOrdinaryPagerInfo {
	private String messageType;
	private String respCode;
	private String respCodeDesc;
	private String userId;
	private String hqykye;
	...
	public String getHqykye() {
		return hqykye;
	}

	public void setHqykye(String hqykye) {
		this.hqykye = hqykye;
	}

	@Override
	public String toString() {
		return "CurrentToOrdinaryPagerInfo [messageType=" + messageType
				+ ", respCode=" + respCode + ", respCodeDesc=" + respCodeDesc
				+ ", userId=" + userId + ", hqykye=" + hqykye + ", signValue="
				+ signValue + "]";
	}
