...
public class MyApplication extends Application {
    ...
    public UserCenterInfo getLoginUser() {
        ...
        user.setJdrz(SettingUtils.getInstance(instance).getValue("jdrz", ""));
        user.setWxwrz(SettingUtils.getInstance(instance).getValue("wxwrz", ""));
    ...
    public void saveUserInfo(final UserCenterInfo user) {
        ...
        SettingUtils.getInstance(instance).saveValue("zqhb",
                user.getZqhb());
        SettingUtils.getInstance(instance).saveValue("jdrz",
                user.getJdrz());
        SettingUtils.getInstance(instance).saveValue("wxwrz",
                user.getWxwrz());
        SettingUtils.getInstance(instance).saveValue("yhkrz",
                user.getYhkrz());
        SettingUtils.getInstance(instance).saveValue("lxr",
                user.getLxrrz());
    ...
    public void cleanLoginInfo() {
        ...
        SettingUtils.getInstance(instance).remove("jdrz");
        SettingUtils.getInstance(instance).remove("wxwrz");
