...
public class SafeSettingActivity extends BaseActivity implements
    ...
    public void initView() {
        ...
        findViewById(R.id.rl_btn_safe_set_act_about_us).setOnClickListener(this);
        findViewById(R.id.rl_btn_safe_set_act_check_ver).setOnClickListener(this);
...
//			}
                break;
            case R.id.rl_btn_safe_set_act_about_us:




                Intent intent = new Intent(SafeSettingActivity.this, H5Activity.class);
                intent.putExtra("title", "关于我们");
                intent.putExtra("url", AbConstant.BASE_URL + "/app/about.html");
...
//			}
            ...
            case R.id.rl_btn_safe_set_act_modify_login_pwd:
                ...
                break;
            case R.id.rl_btn_safe_set_act_check_ver:
                checkVersion();
                break;
